...
//        self.itemSpacing = 100
        self.itemSpacing = self.actualItemSize.width + 0
...
//                return (self.collectionView!.frame.height-self.actualItemSize.height)*0.5
                return self.collectionView!.frame.height - self.actualItemSize.height
            }
            return self.leadingSpacing + CGFloat(numberOfItems)*self.itemSpacing
        }()
    ...
    fileprivate func applyTransform(to attributes: FSPagerViewLayoutAttributes, with transformer: FSPagerViewTransformer?) {
        ...
        case .horizontal:
            ...
            attributes.position = (attributes.center.x-ruler)/self.itemSpacing
                print("position: \((attributes.center.x-ruler)/self.itemSpacing)")
                print("item: \(attributes.indexPath.item)")
//                attributes.position = ruler
//                print("-------------------------")
//                print(pagerView?.currentIndex)
//                print(ruler)
//                print(attributes.center.x)
//                print(self.itemSpacing)
//                print((attributes.center.x-ruler)/self.itemSpacing)
//                print("-------------------------")
        case .vertical:
